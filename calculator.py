...
btn_clr = Button(root,text='C',bg='white',fg='black',width=5,height=2,command=lambda :clear())
...
btn_equals = Button(root,text='=',bg='white',fg='black',width=5,height=2,command=get_result)
